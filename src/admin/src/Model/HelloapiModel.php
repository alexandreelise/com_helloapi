...
class HelloapiModel extends AdminModel
{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_helloapis.helloapi', 'helloapi', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$this->preprocessData('com_helloapis.helloapi', $data);
	...
	public function getItem($pk = null)
	{
		...
		if ($assoc)
		{
			...
			if ($item->id != null)
			{
				$associations = Associations::getAssociations('com_helloapis', '#__helloapis_details', 'com_helloapis.item', $item->id, 'id', null);
		...
		if (Associations::isEnabled())
		{
			...
			if (count($languages) > 1)
			{
				...
				foreach ($languages as $language)
				{
					...
					$field->addAttribute('type', 'modal_helloapi');
